exports.parseFullName = function parseFullName(
  ...
  if ( useLongLists ) {
    ...
    suffixList = ['esq','esquire','jr','jnr','sr','snr','2','ii','iii','iv',
      'md','phd','j.d.','ll.m.','m.d.','d.o.','d.c.','p.c.','ph.d.', 'dis','dr.h.c', 
      'drhc','dsc','llm','md','mba','phd','thd','csc','drsc'];
    ...
    titleList = ['dr','miss','mr','mrs','ms','prof','sir','frau','herr','hr',
      ...
      'bc','bca','doc','ing','ing arch','judr','mddr','mga','mgr','mudr',
      'mvdr','pharmdr','phdr','prof','rndr','thdr','thlic','paedr','dr', 'phmr', 'mx'];
  }
